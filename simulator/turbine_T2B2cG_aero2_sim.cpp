...
#include "turbine_T2B2cG_aero2_direct.hpp"

bool simulate(turbine_T2B2cG_aero2System &system, FAST_Wind* wind, double ts, double tfinal, const std::string &discon_path, const std::string &out_file_name);
bool DISCON_Step(double t, DISCON_Interface &DISCON, turbine_T2B2cG_aero2System &system);
...
int main(int argc, char* argv[]) {
    turbine_T2B2cG_aero2System system;
    FAST_Wind* wind;
    double simtime;
    double simstep;
...
void setupOutputs(FAST_Output &out, turbine_T2B2cG_aero2System &system) {
