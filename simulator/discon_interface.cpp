...
typedef union {
        ...
        struct {
            ...
            float controller_failure; // 161, n, int
...
int main(void) {
    ...
    DISCON_t DISCON = (DISCON_t) dlsym(handle, "DISCON");
    ...
    strcpy(accInfile, "DISCON.IN");
    strcpy(avcOutname, "");
    strcpy(avcMsg, "");
    
    avrSwap.sim_status= 0;
    avrSwap.comm_interval= 0.01;
    avrSwap.min_pitch= 0.0;
    avrSwap.max_pitch= 1.57;
    avrSwap.min_pitch_rate= -0.15;
    avrSwap.max_pitch_rate= 0.15;
    avrSwap.pitch_actuator= 0;
    avrSwap.opt_mode_gain= 1;
    avrSwap.min_gen_speed= 83;
    avrSwap.max_gen_speed= 188;
    avrSwap.gen_speed_dem= 188;
    avrSwap.gen_speed_meas= 188;
    avrSwap.rot_speed_meas= 18.1;
    avrSwap.gen_torque_sp= 20000;
    avrSwap.gen_torque_meas= 20000;
    avrSwap.ts_lut_idx= 0;
    avrSwap.ts_lut_len= 0;
    avrSwap.wind_speed_hub= 10;
    avrSwap.pitch_ctrl_mode= 0;
    avrSwap.yaw_ctrl_mode= 0;
    avrSwap.max_msg_char= 255;
    avrSwap.infile_len= strlen(accInfile);
    avrSwap.outfile_len= strlen(avcOutname);
    avrSwap.num_blades= 3;
    avrSwap.logging_max= 0;
    avrSwap.logging_idx= 0;
    avrSwap.outfile_max= 255;
    
    DISCON(avrSwap.array, &aviFail, accInfile, avcOutname, avcMsg);
    if(aviFail!=0)
        printf("Step 0: %d, %s\n", aviFail, avcMsg);
    else
        printf("Step 0: all well\n");
