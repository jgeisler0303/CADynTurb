...
#include "turbine_T1_aero_direct.hpp"

bool simulate(turbine_T1_aeroSystem &system, FAST_Wind* wind, double ts, double tfinal, const std::string &discon_path, const std::string &out_file_name);
bool DISCON_Step(double t, DISCON_Interface &DISCON, turbine_T1_aeroSystem &system);
...
void setupOutputs(FAST_Output &out, turbine_T1_aeroSystem &system) {
