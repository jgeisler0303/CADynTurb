...
system('g++ -g -std=c++17 -I. -I../../simulator -I../../../CADyn/src ../../../CADyn/src/ODEOrder2.cpp ../../../CADyn/src/IntegratorGNUPlotVisitor.cpp ../../simulator/turbine_T2B2cG_aero_sim.cpp -ldl -o turbine_T2B2cG_aero_sim')
