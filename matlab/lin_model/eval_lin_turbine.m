...
[dTrot_dtow_fa_d, dTrot_dbld_flp_d, dTrot_dbld_edg_d, dTrot_dphi_rot_d, dTrot_dvwind, dTrot_dtheta]= aeroForceDerivs(cm, DLAM_interp(param, param.cm_lut, lam, theta_deg), DTH_interp(param, param.cm_lut, lam, theta_deg), ...
                dcm_dvf_v, dcm_dve_v, ...
                dlam_dvw, dlam_dvtow, dlam_dphi_rot_d, ...
                Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw);

[dFthrust_dtow_fa_d, dFthrust_dbld_flp_d, dFthrust_dbld_edg_d, dFthrust_dphi_rot_d, dFthrust_dvwind, dFthrust_dtheta]= aeroForceDerivs(ct, DLAM_interp(param, param.ct_lut, lam, theta_deg), DTH_interp(param, param.ct_lut, lam, theta_deg), ...
                dct_dvf_v, dct_dve_v, ...
                dlam_dvw, dlam_dvtow, dlam_dphi_rot_d, ...
                Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw);

[dmodalFlapForce_dtow_fa_d, dmodalFlapForce_dbld_flp_d, dmodalFlapForce_dbld_edg_d, dmodalFlapForce_dphi_rot_d, dmodalFlapForce_dvwind, dmodalFlapForce_dtheta]= aeroForceDerivs(cflp, DLAM_interp(param, param.cf_lut, lam, theta_deg), DTH_interp(param, param.cf_lut, lam, theta_deg), ...
                dcf_dvf_v, dcf_dve_v, ...
                dlam_dvw, dlam_dvtow, dlam_dphi_rot_d, ...
                Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw);

[dmodalEdgeForce_dtow_fa_d, dmodalEdgeForce_dbld_flp_d, dmodalEdgeForce_dbld_edg_d, dmodalEdgeForce_dphi_rot_d, dmodalEdgeForce_dvwind, dmodalEdgeForce_dtheta]= aeroForceDerivs(cedg, -1.0*DLAM_interp(param, param.ce_lut, lam, theta_deg), -1.0*DTH_interp(param, param.ce_lut, lam, theta_deg), ...
                dce_dvf_v, dce_dve_v, ...
                dlam_dvw, dlam_dvtow, dlam_dphi_rot_d, ...
                Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw);
