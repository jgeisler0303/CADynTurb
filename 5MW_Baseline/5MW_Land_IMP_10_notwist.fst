...
FAST Certification Test #18: NREL 5.0 MW Baseline Wind Turbine (Onshore), generated from template 5MW_Land_v{{uref}}_d{{vdir}}_s{{seed}}.fst.ms by jgeisler on 07/03/20
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_Onshore_ElastoDyn_notwist.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NRELOffshrBsline5MW_InflowWind_IMP_10.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
