...
tracking = true;
DISCON_MPC_dll = compileMPC_DISCON(model_name, model_dir, ocp_path, ekf_model_path, CADynTurb_dir, false, tracking);
...
run(fullfile(ekf_model_path, 'model_parameters.m'))
...
clc
cd(gen_dir)
figures_dir = fullfile(ocp_path, 'Classic_vs_MPC');
