%% Demonstration/Test Extended Kalman Filter with wind estimation and tower fa, rotational, drive train and collective blade DOF based on RK1 solver
...
for  i= find(ref_sims.vv==v & ref_sims.yaw==0)'
    ...
    plot_timeseries_multi({d_FAST, d_sim, d_sim_RK1}, {'RAWS', 'BlPitchC', 'LSSTipVxa', 'HSShftV', 'YawBrTDxp', 'Q_BF1'}, {'FAST', 'Newmark', 'RK1'});
end
...
for  i= find(ref_sims.vv==v & ref_sims.yaw==0)'
    ...
    plot_timeseries_multi({d_in, d_est2, d_est_RK1, d_est_RK12}, {'RAWS', 'Q_TFA1' 'Q_BF1' 'LSSTipVxa', 'Q_DrTr'}, {'FAST', 'Newmark', 'RK1 1', 'RK1 2'})
end
