function ekf_config= T2B2cG_est_bld_mom_filt_ekf_config
model_indices
...
ekf_config.out_idx= [out_tow_fa_acc_idx, out_tow_ss_acc_idx, out_gen_speed_idx, out_r_bld_flp_mom_filt_idx, out_r_bld_edg_mom_filt_idx];
