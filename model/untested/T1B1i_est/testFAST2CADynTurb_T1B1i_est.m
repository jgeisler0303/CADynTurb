...
param.fixedQxx(ix_h_shear)= (10^-4)^2; %(10^-4)^2; % for 10ms
param.fixedQxx(ix_v_shear)= (10^-4)^2; %(10^-4)^2; % for 10ms
...
for  i= find(ref_sims.vv==12 & ref_sims.yaw==0)'
    ...
    [~, ~, ~, ~, ~, ~, Q, R, x_end, P_end]= run_simulation(model_name, d_in, param, [], 0, 2, Q, R, [], x_end, P_end);
