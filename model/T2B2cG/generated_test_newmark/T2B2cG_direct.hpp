/* File generated form template cadyn_direct.cpp.tem on 2023-08-04 09:37:42+02:00. Do not edit! */
...
const T2B2cG::inputs_idx_type T2B2cG::inputs_idx= {0, 1, 2};
const T2B2cG::outputs_idx_type T2B2cG::outputs_idx= {0, 1, 2, 3, 4, 5, 6};

T2B2cG::T2B2cG() : 
    NewmarkBeta("T2B2cG", "Simulation of a simplified horizontal axis wind turbine"),
    param(),
...
T2B2cG::VecQ T2B2cG::computeResiduals() {
    ...
    }
    {
        ...
        f_[1]=-temp10*(qdd[1]*pow(param.tower_frame_11_psi0_1_2,2.0)*(param.NacMass*(-temp4*temp9-pow(param.NacCMyn,2.0)*temp9)-3.0*param.blade_mass*temp6*temp9-param.HubMass*temp6*temp9-param.NacXIner*temp9-param.GenIner*temp9+temp14*temp7+temp13+temp12)+param.tower_frame_11_psi0_1_2*(qdd[1]*param.tower_frame_11_origin1_2_2_1*(6.0*param.Twr2Shft*param.blade_mass*temp9+2.0*param.HubMass*param.Twr2Shft*temp9+2.0*param.NacCMzn*param.NacMass*temp9)+temp2*(3.0*qdd[3]*param.blade_Cr0_2_2*temp9+3.0*qdd[2]*param.blade_Cr0_1_2*temp9)+temp1*(-3.0*qdd[3]*param.blade_Cr0_2_1*temp9-3.0*qdd[2]*param.blade_Cr0_1_1*temp9)-param.NacCMyn*param.NacMass*param.g*temp9-Ftow_y*param.NacCMzn*temp9-qdd[5]*param.GenIner*temp9+Trot*temp9-u[1]*temp9+qdd[4]*temp14*temp7+qdd[4]*(temp13+temp12)+q[4]*param.DTTorSpr*param.GBRatio+qd[4]*param.DTTorDmp*param.GBRatio-q[5]*param.DTTorSpr-qd[5]*param.DTTorDmp)+qdd[0]*param.NacCMxn*param.NacCMyn*param.NacMass*param.tower_frame_11_psi0_1_2*param.tower_frame_11_psi0_2_1*
         temp9+Ftow_y*param.tower_frame_11_origin1_2_2_1*temp9-qdd[1]*param.tower_Me0_2_2*temp9-q[1]*param.tower_K0_2_2*temp9-qd[1]*param.tower_D0_2_2*temp9-q[1]*param.g*param.tower_Ct1_2_2_3*temp9+q[1]*param.g*param.tower_frame_11_phi1_2_3_2*temp11+qdd[1]*pow(param.tower_frame_11_origin1_2_2_1,2.0)*temp11);
        ...
        f_[4]=-((q[0]*qd[0]*(qd[4]*temp26*temp7+qd[4]*temp24)+(temp27+temp25+temp17)*temp28)*temp8+qdd[1]*param.tower_frame_11_psi0_1_2*(temp26*temp7+temp23+temp22)+temp27+temp25+temp21+temp20+(3.0*qdd[3]*param.GBRatio*param.blade_Cr0_2_2+3.0*qdd[2]*param.GBRatio*param.blade_Cr0_1_2)*temp2+temp19+temp18+temp17+(-3.0*qdd[3]*param.GBRatio*param.blade_Cr0_2_1-3.0*qdd[2]*param.GBRatio*param.blade_Cr0_1_1)*temp1)/pow(param.GBRatio,1.0);
        f_[5]=temp10*(temp8*(qdd[5]*param.GenIner*temp28*temp9+q[0]*qd[0]*qd[5]*param.GenIner*temp9)+qdd[1]*param.GenIner*param.tower_frame_11_psi0_1_2*temp9+qdd[5]*param.GenIner*temp9+u[1]*temp9+temp21+temp20+temp19+temp18);
    }
...
void T2B2cG::calcJacobian(real_type alphaM, real_type alphaC, real_type alphaK) {
    ...
    }
    {
        ...
        real_type temp45=pow(q[0],2.0);
        real_type temp46=-param.NacCMxn*param.NacCMyn*param.NacMass*param.tower_frame_11_psi0_1_2*param.tower_frame_11_psi0_2_1;
        real_type temp47=param.tower_frame_11_psi0_2_1*temp29+param.tower_frame_11_origin1_1_1_1*temp27;
        real_type temp48=param.tower_frame_11_psi0_2_1*temp32+param.tower_frame_11_origin1_1_1_1*temp30;
        real_type temp49=-3.0*param.blade_I0_2_2;
        real_type temp50=temp12*(temp9+temp49);
        real_type temp51=param.tower_frame_11_psi0_1_2*temp28;
        real_type temp52=param.tower_frame_11_psi0_1_2*temp31;
        real_type temp53=temp50+temp10+param.HubIner;
        real_type temp54=param.tower_frame_11_psi0_1_2*temp53;
        real_type temp55=param.GenIner*param.tower_frame_11_psi0_1_2;
        real_type temp56=-3.0*param.blade_mass-param.NacMass-param.HubMass;
        real_type temp57=-param.HubIner;
        real_type temp58=qd[4]*(temp57+temp49)+qd[4]*temp11*temp12;
        real_type temp59=-param.DTTorSpr*temp33;
        real_type temp60=-param.DTTorDmp*temp33;
        ...
        M(0, 5)=0.0;
        M(1, 0)=temp46;
        M(1, 1)=temp24*(3.0*param.blade_mass*temp8+param.HubMass*temp8+param.NacMass*(temp6+temp23)+temp50+temp10+param.NacXIner+param.HubIner+param.GenIner)+(3.0*param.blade_mass+param.NacMass+param.HubMass)*temp19+(-6.0*param.Twr2Shft*param.blade_mass-2.0*param.HubMass*param.Twr2Shft-2.0*param.NacCMzn*param.NacMass)*param.tower_frame_11_origin1_2_2_1*param.tower_frame_11_psi0_1_2+param.tower_Me0_2_2;
        M(1, 2)=temp51;
        M(1, 3)=temp52;
        M(1, 4)=temp54;
        M(1, 5)=temp55;
        ...
        M(4, 2)=temp28;
        M(4, 3)=temp31;
        M(4, 4)=temp15*temp45*temp53+temp50+temp10+param.HubIner;
        M(4, 5)=0.0;
        M(5, 0)=0.0;
        M(5, 1)=temp55;
        M(5, 2)=0.0;
        M(5, 3)=0.0;
        M(5, 4)=0.0;
        M(5, 5)=param.GenIner*temp15*temp45+param.GenIner;
        ...
        C(1, 1)=dFtow_y_dtow_ss_d*param.NacCMzn*param.tower_frame_11_psi0_1_2-dFtow_y_dtow_ss_d*param.tower_frame_11_origin1_2_2_1+param.tower_D0_2_2;
        ...
        C(3, 5)=0.0;
        C(4, 0)=-temp15*(q[0]*temp58+dTrot_dtow_fa_d*temp45)-dTrot_dtow_fa_d;
        C(4, 1)=0.0;
        C(4, 2)=-dTrot_dbld_flp_d*temp15*temp45-dTrot_dbld_flp_d;
        C(4, 3)=-dTrot_dbld_edg_d*temp15*temp45-dTrot_dbld_edg_d;
        C(4, 4)=-temp15*(q[0]*qd[0]*(temp57+temp49+temp13)+dTrot_dphi_rot_d*temp45)+param.DTTorDmp-dTrot_dphi_rot_d;
        C(4, 5)=temp60;
        ...
        K(0, 0)=-param.g*param.tower_frame_11_phi1_1_3_1*temp56-Fthrust*param.OverHang*temp15+param.tower_K0_1_1+param.g*param.tower_Ct1_1_1_3;
        K(0, 1)=0.0;
        ...
        K(0, 5)=0.0;
        K(1, 0)=0.0;
        K(1, 1)=-param.g*param.tower_frame_11_phi1_2_3_2*temp56+param.tower_K0_2_2+param.g*param.tower_Ct1_2_2_3;
        K(1, 2)=0.0;
        K(1, 3)=0.0;
        ...
        K(3, 4)=0.0;
        K(3, 5)=0.0;
        K(4, 0)=-temp15*(qd[0]*temp58+q[0]*(qdd[4]*(6.0*param.blade_I0_2_2-6.0*param.blade_I0_1_1)*temp12+qdd[4]*(-6.0*param.blade_I0_2_2-2.0*param.HubIner)+2.0*Trot));
        K(4, 1)=0.0;
        K(4, 2)=0.0;
        K(4, 3)=0.0;
        ...
        f[4]=-temp33*(temp15*((temp44+temp42+temp34)*temp45+q[0]*qd[0]*(qd[4]*temp12*temp43+qd[4]*temp41))+temp44+qdd[1]*param.tower_frame_11_psi0_1_2*(temp12*temp43+temp40+temp39)+temp42+temp38+temp37+temp36+temp35+temp34+(3.0*qdd[3]*param.GBRatio*param.blade_Cr0_2_2+3.0*qdd[2]*param.GBRatio*param.blade_Cr0_1_2)*temp2+(-3.0*qdd[3]*param.GBRatio*param.blade_Cr0_2_1-3.0*qdd[2]*param.GBRatio*param.blade_Cr0_1_1)*temp1);
        f[5]=temp17*(temp15*(qdd[5]*param.GenIner*temp16*temp45+q[0]*qd[0]*qd[5]*param.GenIner*temp16)+temp38+temp37+temp36+temp35+qdd[1]*param.GenIner*param.tower_frame_11_psi0_1_2*temp16+qdd[5]*param.GenIner*temp16+u[1]*temp16);
    }
