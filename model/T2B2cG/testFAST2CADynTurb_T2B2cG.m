%% Demonstration/Test simulation of a model with tower fa and ss, rotational, collective flap and edge DOF using cpp compiled standalone simulator
...
plot_timeseries_cmp(d_sim, d_sim_100ms, {'RAWS', 'BlPitchC', 'HSShftV', 'GenTq', 'YawBrTDxp', 'YawBrTDyp', 'Q_BF1', 'Q_BE1'});
...
plot_timeseries_cmp(d_sim, d_mex, {'RAWS', 'BlPitchC', 'HSShftV', 'GenTq', 'YawBrTDxp', 'YawBrTDyp', 'Q_BF1', 'Q_BE1'});
% plot_timeseries_cmp(d_sim, d_mex, {'RAWS', 'LSSTipVxa', 'HSShftV', 'Q_DrTr', 'YawBrTDxp', 'YawBrTDyp', 'Q_BF1', 'Q_BE1'});

%% sim mex model 100ms (feedforward)
clc
d_mex_100ms= run_simulation(model_name, d_sim_100ms, param);
plot_timeseries_cmp(d_sim_100ms, d_mex_100ms, {'RAWS', 'Q_DrTr', 'HSShftV', 'Q_GeAz', 'YawBrTDxp', 'YawBrTDyp', 'Q_BF1', 'Q_BE1'});
