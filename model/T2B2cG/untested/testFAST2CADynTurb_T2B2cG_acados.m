...
%%
if ispc
    system('g++ -fpermissive -g -std=c++17 -D _USE_MATH_DEFINES -I. -I../../simulator -Ic_generated_code -I$ACADOS_INSTALL_DIR/include -I$ACADOS_INSTALL_DIR/include/blasfeo/include -I$ACADOS_INSTALL_DIR/include/hpipm/include ../../simulator/T2B2cG_acados.cpp c_generated_code/acados_sim_solver_T2B2cG.c c_generated_code/T2B2cG_model/T2B2cG_impl_dae_fun_jac_x_xdot_u.c c_generated_code/T2B2cG_model/T2B2cG_impl_dae_fun_jac_x_xdot_z.c c_generated_code/T2B2cG_model/T2B2cG_impl_dae_fun.c c_generated_code/T2B2cG_model/T2B2cG_impl_dae_hess.c c_generated_code/T2B2cG_model/T2B2cG_impl_dae_jac_x_xdot_u_z.c -L$ACADOS_INSTALL_DIR/lib -lacados -lblasfeo -lhpipm -o T2B2cG_acados');
else
...
%%
sim_command= 'T2B2cG_acados -a 0.965 -o simp_12_6DOF_acados.outb ../../5MW_Baseline/5MW_Land_IMP_12.fst';
if isunix
