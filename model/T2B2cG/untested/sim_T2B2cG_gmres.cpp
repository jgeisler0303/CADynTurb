...
#include "T2B2cG_direct_gmres.hpp"

bool simulate(T2B2cG &system, FAST_Wind* wind, double ts, double tfinal, const std::string &discon_path, const std::string &out_file_name);
