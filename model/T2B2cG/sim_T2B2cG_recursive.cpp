...
#include "T2B2cG_recursive.hpp"

bool simulate(T2B2cG &system, FAST_Wind* wind, double ts, double tfinal, const std::string &discon_path, const std::string &out_file_name, FAST_Parent_Parameters &p, double rpm0);
bool DISCON_Step(double t, DISCON_Interface &DISCON, T2B2cG &system);
void initTorquePitch(double vwind, double om_rot, double &torque, double &pitch, T2B2cGParameters &sys_param, FAST_Parent_Parameters &p);
...
void setupOutputs(FAST_Output &out, T2B2cG &system) {
...
typedef decltype(std::declval<T2B2cG>().param.cm_lut) MatCx;
...
double Trot(double vwind, double om_rot, double pitch, T2B2cGParameters *param) {
...
void initTorquePitch(double vwind, double om_rot, double &torque, double &theta_deg, T2B2cGParameters &sys_param, FAST_Parent_Parameters &p) {
    theta_deg= 0.0;
