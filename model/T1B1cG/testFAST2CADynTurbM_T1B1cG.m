%% Demonstration/Test simulation of a model with tower fa, rotational, drive train and collective blade DOF using cpp compiled standalone simulator based on RK1 solver
