...
void turbine_T2B2cG_aero_est_bld_mom_3pSystem::calculateExternal() {
    theta_deg= -inputs.theta/M_PI*180.0;
    double vwind_eff= states.vwind-states.tow_fa_d + states.v3p;
...
static void aeroForceDerivs(const double torque_R, const double cx_stat, const double dcx_dlam, const double dcx_dtheta, 
                            ...
                            double &dX_dtow_fa_d, double &dX_dphi_rot_d, double &dX_dbld_flp_d, double &dX_dbld_edg_d, double &dX_dvwind, double &dX_dtheta, double &dX_dv3p) {
...
void turbine_T2B2cG_aero_est_bld_mom_3pSystem::calculateExternalWithDeriv() {
    theta_deg= -inputs.theta/M_PI*180.0;
    double vwind_eff= states.vwind-states.tow_fa_d + states.v3p;
    lam= states.phi_rot_d*param.Rrot/vwind_eff;
    ...
    aeroForceDerivs(param.Rrot, cm, DLAM_LUT(param.cm_lut), DTH_LUT(param.cm_lut), 
                    ...
                    dTrot_dtow_fa_d, dTrot_dphi_rot_d, dTrot_dbld_flp_d, dTrot_dbld_edg_d, dTrot_dvwind, dTrot_dtheta, dTrot_dv3p);
    
    aeroForceDerivs(1.0, ct, DLAM_LUT(param.ct_lut), DTH_LUT(param.ct_lut), 
                    dct_dvf_v, dct_dve_v, 
                    dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                    Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw, 
                    dFthrust_dtow_fa_d, dFthrust_dphi_rot_d, dFthrust_dbld_flp_d, dFthrust_dbld_edg_d, dFthrust_dvwind, dFthrust_dtheta, dFthrust_dv3p);
    ...
    aeroForceDerivs(1.0, cflp, DLAM_LUT(param.cf_lut), DTH_LUT(param.cf_lut), 
                    ...
                    dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                    Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw, 
                    dmodalFlapForce_dtow_fa_d, dmodalFlapForce_dphi_rot_d, dmodalFlapForce_dbld_flp_d, dmodalFlapForce_dbld_edg_d, dmodalFlapForce_dvwind, dmodalFlapForce_dtheta, dmodalFlapForce_dv3p);
    
    aeroForceDerivs(1.0, cedg, -1.0*DLAM_LUT(param.ce_lut), -1.0*DTH_LUT(param.ce_lut), 
                    dce_dvf_v, dce_dve_v, 
                    dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                    Fwind, Fwind_v, dFwind_dvtow, dFwind_dvw, 
                    dmodalEdgeForce_dtow_fa_d, dmodalEdgeForce_dphi_rot_d, dmodalEdgeForce_dbld_flp_d, dmodalEdgeForce_dbld_edg_d, dmodalEdgeForce_dvwind, dmodalEdgeForce_dtheta, dmodalEdgeForce_dv3p);
