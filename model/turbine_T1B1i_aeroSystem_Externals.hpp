...
typedef decltype(std::declval<turbine_T1B1i_aeroSystem>().param.cm_lut) MatCx;
...
void turbine_T1B1i_aeroSystem::calculateExternal() {
...
void turbine_T1B1i_aeroSystem::calculateExternalWithDeriv() {
    theta_deg1= -inputs.theta1/M_PI*180.0;
    theta_deg2= -inputs.theta2/M_PI*180.0;
    theta_deg3= -inputs.theta3/M_PI*180.0;
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx1, thetaFact1, param.lambdaStep, param.thetaStep, u_1,
                       ...
                       Fwind, Fwind_v, vwind_eff, states.bld1_flp_d, states.phi_rot, 0.0, inputs.h_shear, inputs.v_shear, param.Rrot/3.0,
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx2, thetaFact2, param.lambdaStep, param.thetaStep, u_2,
                       param.cm_lut, param.dcm_dvf_v_lut, param.dcm_dkappa_v_lut, 
                       Fwind, Fwind_v, vwind_eff, states.bld2_flp_d, states.phi_rot, 2.0/3.0*M_PI, inputs.h_shear, inputs.v_shear, param.Rrot/3.0,
                       dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                       dFwind_dvtow, dFwind_dvw, 
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx3, thetaFact3, param.lambdaStep, param.thetaStep, u_3,
                       param.cm_lut, param.dcm_dvf_v_lut, param.dcm_dkappa_v_lut, 
                       Fwind, Fwind_v, vwind_eff, states.bld3_flp_d, states.phi_rot, 4.0/3.0*M_PI, inputs.h_shear, inputs.v_shear, param.Rrot/3.0,
                       dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                       dFwind_dvtow, dFwind_dvw, 
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx1, thetaFact1, param.lambdaStep, param.thetaStep, u_1,
                       ...
                       Fwind, Fwind_v, vwind_eff, states.bld1_flp_d, states.phi_rot, 0.0, inputs.h_shear, inputs.v_shear, 1.0/3.0,
                       dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                       dFwind_dvtow, dFwind_dvw, 
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx2, thetaFact2, param.lambdaStep, param.thetaStep, u_2,
                       param.ct_lut, param.dct_dvf_v_lut, param.dct_dkappa_v_lut, 
                       Fwind, Fwind_v, vwind_eff, states.bld2_flp_d, states.phi_rot, 2.0/3.0*M_PI, inputs.h_shear, inputs.v_shear, 1.0/3.0,
                       dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                       dFwind_dvtow, dFwind_dvw, 
    ...
    aeroForceAndDerivs(lambdaIdx, lambdaFact, thetaIdx3, thetaFact3, param.lambdaStep, param.thetaStep, u_3,
                       param.ct_lut, param.dct_dvf_v_lut, param.dct_dkappa_v_lut, 
                       Fwind, Fwind_v, vwind_eff, states.bld3_flp_d, states.phi_rot, 4.0/3.0*M_PI, inputs.h_shear, inputs.v_shear, 1.0/3.0,
                       dlam_dvw, dlam_dvtow, dlam_dphi_rot_d,
                       dFwind_dvtow, dFwind_dvw, 
