...
typedef decltype(std::declval<turbine_T1B1i_aero_estSystem>().param.cm_lut) MatCx;
...
void turbine_T1B1i_aero_estSystem::calculateExternal() {
...
void turbine_T1B1i_aero_estSystem::calculateExternalWithDeriv() {
    theta_deg1= -inputs.theta1/M_PI*180.0;
    theta_deg2= -inputs.theta2/M_PI*180.0;
    theta_deg3= -inputs.theta3/M_PI*180.0;
